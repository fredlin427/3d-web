...
export default function ChartBuilderPage() {
  ...
  const handleExport = async () => { setExporting(true); await exportPNG("chart-builder-preview", `chart-${source}-${xField}`); setExporting(false); };
    ...
    <div className="space-y-6 max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-6 gap-6">
        ...
        <div className="lg:col-span-5 space-y-4">
          <Card className="border-0 shadow-sm overflow-visible">
            ...
            <CardContent className="!p-2" id="chart-builder-preview" ref={containerRef}>
              <ChartFullscreen title={title}>
                ...
                : isPie ? (
                  <DonutChart data={donutData} colors={colors} total={total} height={500} composite={hasStacked}
          ...
          {hasStacked && legendItems.length > 0 && <ChartLegend items={legendItems} />}
